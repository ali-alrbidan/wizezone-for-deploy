    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <motion.p
          ...
          `}
        >
          The training and consulting platform that opens the doors to
          professional success for you.
          <br />
          We help you acquire the skills that make a difference in your career.
        </motion.p>
        ...
        >
          ...
          <p className="text-sm sm:text-md lg:text-[17px] font-medium">
            Learn. Grow. Lead With Trusted Training & Consulting
          </p>
        </motion.div>
