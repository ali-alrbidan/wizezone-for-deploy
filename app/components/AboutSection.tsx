    ...
    <section className="py-24 bg-white dark:bg-zinc-900 transition-colors duration-200">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-[0.4fr_0.6fr] gap-12 items-stretch">
        ...
        >
          ...
          >
            WISE ZONE was founded in 2016 in Amman. To start serving both
            locally and internationally in a wide range of training areas.
          </motion.p>
          ...
          >
            ...
            <div className="text-box flex-1">
              ...
              <p className="text-gray-700 dark:text-white/70 leading-relaxed">
                To contribute in the regional and international educational and
                business progress by being a supportive partner ready to serve
                both timely and qualitatively in all over MENA region.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="text-box flex-1">
              ...
              <p className="text-gray-700 dark:text-white/70 leading-relaxed">
                To allocate all our resources to turn challenges into
                opportunities through the best-fit instructors, knowledge, &
                technology, in ways that will add value to our clients, meeting
                their satisfaction, and saturating their needs; and build long
                relationship as business partner while maintaining our edge of
                Excellence.
              </p>
            </div>
          </motion.div>
