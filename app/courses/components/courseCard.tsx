...
//         ${isOpen ? "bg-[#0b0b3acc]" : "bg-[#FFFFFF1A]"}
//         cursor-pointer
//       `}
//       onClick={() => setOpenId(isOpen ? null : item.id)} // الضغط على الكارد كله يفتح/يغلق
//     >
//       {/* header */}
//       <div className="flex items-center justify-between">
//         <div>
//           <p className="text-white/50 text-base mb-1">Course</p>
...
//             animate={{ rotate: isOpen ? 45 : 0 }} // السهم يتغير حسب isOpen
//             transition={{
//               type: "spring",
//               stiffness: 260,
//               damping: 18,
...
//           >
//             <div className="mt-4 bg-[#FFFFFF1A] border border-[#575DBF] rounded-2xl p-4">
