...
function NewsCard({
  ...
  return (
    <motion.div
      ...
      className={`
        group
        border-2 border-gray-100 dark:border-slate-700/40
    ...
    >
      ...
      >
        <motion.div
          ...
          className="bg-gray-50 dark:bg-zinc-900/90 border-2 border-gray-100 dark:border-slate-700/40 rounded-2xl p-4"
        >
        ...
        <div>
          {loading ? (
            ...
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="text-center py-12 border border-dashed border-gray-300 dark:border-gray-600 rounded-3xl bg-gray-50 dark:bg-slate-700/10"
            >
