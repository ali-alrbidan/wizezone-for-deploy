...
export default function StyledGoogleMap() {
  const t = useTranslations("StyledGoogleMap");
            ...
            ">
              ...
              <div style="display: flex; align-items: flex-start; gap: 10px; margin-bottom: 12px;">
                ...
                <p style="margin: 0; font-size: 13.5px; color: #94a3b8; line-height: 1.5;">
                  ${t("infoWindow.address")}<br/>
                  ${t("infoWindow.country")}
                </p>
              </div>
  ...
  return (
    <section
      ref={containerRef}
      className=" md:mt-10 relative py-16 md:py-20 bg-gradient-to-b from-white to-slate-50 dark:from-slate-700/10 dark:to-black overflow-hidden"
    >
      <div className="absolute inset-0">
        <div className="dark:hidden absolute inset-0 bg-gradient-to-br from-orange-50/50 via-transparent to-blue-50/50" />

        <div className="hidden dark:block absolute inset-0 bg-gradient-to-br from-slate-700/20 via-slate-700/10 to-slate-700/5" />
